...
// 1. Core Module
angular.module('Elidom.Core', ['ionic', 'ngCordova', 'ngResource', 'oc.lazyLoad', 'LocalStorageModule', 'ionic-datepicker', 'ionic-material', 'ionMdInput', 'chart.js', 'dataludi','ngFileUpload','react','pasvaz.bindonce']);
